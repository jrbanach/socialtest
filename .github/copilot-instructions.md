...
### Data
- `QUIZ_REGISTRY` — 8 quizzes: Colonial America (Ch 5–6), Minerals, Rocks & Rock Cycle, Health Ch7, Weather & Atmosphere, American Revolution (Ch 8–9), Health Ch8, Matter & Elements
...
- Currently 263 tests covering quiz data, scoring, battle state, quest engine, equipment, XP, boss mechanics, titles, matching, multi-quiz support, and quiz-scoped high-score filtering
...
| `tests.html` | Unit test suite (263 tests) |
